...
By default, build output is shown directly. If you have `nix-output-monitor`
installed and want to use it:

```bash
nh os switch --build-host buildserver --nom
```

This pipes the remote build output through `nom` for a better visual
representation.
